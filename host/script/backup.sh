...
python3 -m hiauntie_py.toot verbose "URLKLBPN backup ${TIMESTAMP_FULL} start" || true

ssh hiauntie_bot@hiauntie.com -C /home/hiauntie_bot/maintenance.hiauntie.com/hiauntie/script/backup.bot.sh

cd /home/hiauntie_bot/maintenance.hiauntie.com
python3 -m hiauntie_py.toot verbose "HHNSHGUM backup ${TIMESTAMP_FULL} end" || true
