...
python3 -m hiauntie_py.toot --account verbose --msg "URLKLBPN data backup ${TIMESTAMP_FULL} start" || true

ssh hiauntie_bot@hiauntie.com -C /home/hiauntie_bot/maintenance.hiauntie.com/hiauntie/script/backup.bot.sh

cd /home/hiauntie_bot/maintenance.hiauntie.com
python3 -m hiauntie_py.toot --account verbose --msg "HHNSHGUM data backup ${TIMESTAMP_FULL} end" || true
